...
public class TrackingRestControllerTest {
    ...
    public void testGetAllTrackingsForUser() throws Exception {
        this.mockMvc.perform(get("/trackings/getAllTrackings").header("token", tokenAlexander).contentType(MediaType.APPLICATION_JSON))
    ...
    public void testGetNoTrackingsForUser() throws Exception {
        this.mockMvc.perform(get("/trackings/getAllTrackings").header("token", tokenWout).contentType(MediaType.APPLICATION_JSON))
